...
myArray = {}
myArray = TableConcat(array1, array2);
array1 = nil
array2 = nil
myArray = TableConcat(myArray, array3);
array3 = nil
myArray = TableConcat(myArray, array4);
array4 = nil
myArray = TableConcat(myArray, array5);
array5 = nil
myArray = TableConcat(myArray, array6);
array6 = nil
myArray = TableConcat(myArray, array7);
array7 = nil
myArray = TableConcat(myArray, array8);
array8 = nil
myArray = TableConcat(myArray, array9);
array9 = nil
myArray = TableConcat(myArray, array10);
array10 = nil
myArray = TableConcat(myArray, array11);
array11 = nil
myArray = TableConcat(myArray, array12);
array12 = nil
...
--myArray[lightnum] = math.random(255)
--print(myArray[lightnum])

if (myArray[lightnum] <= rowNumber) then
...
mytimer:register(80, tmr.ALARM_AUTO, function()
    print("lightUpRowNumberLoop")
    rowNumber = rowNumber + 1
    if(rowNumber > 91)then 
        rowNumber =1 
